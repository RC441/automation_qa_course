...
class LinksPage(BasePage):
    ...
    def check_new_tab_simple_link(self):
        ...
        send_request = requests.get(link_href)
        if send_request.status_code == 200:
            ...
            return link_href, send_request.status_code
...
class UploadAndDownloadPage(BasePage):
    ...
    def download_file(self):
        ...
        path_name_file = rf'E:\Automation_Projects\PycharmProjects\automation_qa_course\test_files\filetest{random.randint(0, 999)}.jpg'
